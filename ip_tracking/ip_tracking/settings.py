...
SECRET_KEY = 'django-insecure-ek^zysh#ua4@w1dc04awa4!s$bdlz-84#cdw1=lc=&w*uo_p3_'
...
# ----- Celery (anomaly detection) -----
CELERY_BROKER_URL = "redis://127.0.0.1:6379/0"  # or your broker of choice
...
# ----- Optional: data retention (clean old logs) -----
IP_TRACKING_LOG_RETENTION_DAYS = 30